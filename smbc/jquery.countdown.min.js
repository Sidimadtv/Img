...
/* The Countdown Pro Server Sync */
function tcpServerSync(){var e=null;jQuery.ajax({type:"POST",url:tcp.ajaxurl,async:false,data:{action:tcp.action,nonce:tcp.nonce},success:function(t){e=new Date(t)},error:function(t,n,r){e=new Date}});return e}